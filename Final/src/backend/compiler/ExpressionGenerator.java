...
public class ExpressionGenerator extends CodeGenerator
{
     ...
     */
    public void emitExpression(projectParser.ExpressionContext ctx)
    {
     ...
     */
    public void emitSimpleExpression(projectParser.SimpleExpressionContext ctx)
    {
     ...
     */
    public void emitTerm(projectParser.TermContext ctx)
    {
     ...
     */
    public void emitNotFactor(projectParser.NotFactorContext ctx)
    {
     ...
     */
    public void emitLoadValue(projectParser.VariableContext varCtx)
    {
        ...
        if (modifierCount > 0)
        {
            projectParser.ModifierContext lastModCtx =
                                    varCtx.modifier().get(modifierCount - 1);
            
            if (lastModCtx.index() != null)
            {
     ...
     */
    public Typespec emitLoadVariable(projectParser.VariableContext varCtx)
    {
        ...
        {
            projectParser.ModifierContext modCtx = varCtx.modifier().get(i);
           ...
           /*/ if (modCtx.index() != null)
            {
                variableType = emitLoadArrayElementAccess(
                                modCtx.index(), variableType, lastModifier);
            }/*/
    ...
    /*/private Typespec emitLoadArrayElementAccess(
                                    projectParser.IndexContext indexListCtx,
     ...
     */
    public void emitLoadIntegerConstant(projectParser.NumberContext intCtx)
    {
     ...
     * @parm intCtx the IntegerConstantContext.
     */
    public void emitLoadRealConstant(projectParser.NumberContext realCtx)
    {
