...
public class ProgramGenerator extends CodeGenerator
{
     ...
     */
    public void emitProgram(projectParser.ProgramContext ctx)
    {
     ...
     * @param ctx the ProgramContext.
     */
    private void emitMainMethod(projectParser.ProgramContext ctx)
    {
        emitLine();
        emitComment("MAIN");
     ...
     */
   /*/ public void emitFunction(projectParser.FunctionDefinitionContext ctx)
    {
